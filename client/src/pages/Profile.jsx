        ...
        userListings.map((listing, index) => (
          ...
          <div key={listing._id} class="group flex flex-col h-full my-3 w-auto sm:w-full bg-white border border-gray-200 shadow-sm rounded-xl hover:shadow-md  ">
                ...
                <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 ">
                  <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-blue-500 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none " href="#">
                    Edit
                  </a>
                  <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-red-600 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none " href="#">
                    Delete
                  </a>
                </div>
              </div>
