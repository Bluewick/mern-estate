              ...
              {formData.imageUrls.length > 0 &&
                formData.imageUrls.map((url, index) => (
                  <div className="relative">
                    ...
                    {/* <div className="opacity-0  absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 hover:bg-red-600 hover:text-white hover:opacity-100 transition-all duration-300 ease-in-out cursor-pointer">X</div> */}
                  </div>
                ))}
            </div>
          </div>
